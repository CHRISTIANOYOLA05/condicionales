...
if ejercicios == 17:
  print ("programa para saber si un codigo es positivo o negativo")
  ...
  print ("programa para saber cual numero es positivo y negativo")
  
  number1 = int(input("ingresa primer numero:  "))
  ...
  print (" programa que lea tres números enteros positivos, y  el menor y el mayor de todos ellos. ")
  ...
  print ("Calcular el sueldo de los empleados de una empresa. Para ello se deberá pedir el nombre del empleado, las horas normales trabajadas y las horas extras. Tener en cuenta que el valor de la hora es de $4 y que las horas extras se pagan doble.")
  ...
  print("Sueldo total:", sueldo_total)
    ...
    print("Dados dos números A y B sumarlos si A es menor a B sino restarlos")
    ...
    print("numDia es una variable numérica que puede tomar 7 valores, ellos son 1, 2, 3, 4, 5, 6 o 7.Mostar el nombre el nombre del día de la semana que corresponde al valor de la variable numDia.")
...
if ejercicios == 24:
  print("Dadas las longitudes de los tres lados de un triángulo determinar si es equilátero o no.")
  lado1 = 5
  lado2 = 5
  lado3 = 5
...
if ejercicios == 26:
  print("Pidiendo el día y el mes de nacimiento mostrar el signo.")
